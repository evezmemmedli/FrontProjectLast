...
$('.list').click(function(e){
  ...
  $('.shop-products-list-hidden').fadeIn()
  
})
$('.menu').click(function(e){
  e.preventDefault();
  $('.shop-products-list').fadeIn();
  $('.shop-products-list-hidden').css('display','none')
  
})


if($('section').hasClass('single-pro-second')) {
...
function show_total() {
  var total = 0;
  $('tbody .pro-subtotal').each(function(){
    total += parseInt($(this).text());
  })
  $('.total .cart-price-total').text('$'+total);
}

$(document).on('click', '.quantity-up', function(){
  var countdiv = $(this).closest('tr').find('.quantity-count'); 
  var count = parseInt(countdiv.text());
  var newcount = count + 1;
  countdiv.text(newcount);
  var id = $(this).closest('tr').attr('data-id');
  add_to_cart(id);
  var price = products[id]['price'];
  var newprice = newcount * parseInt(price);
  $(this).closest('tr').find('.pro-subtotal').text(newprice);
  show_total();
});
...
if(cart != '') {
  ...
  $.each(newcart , function(index, val) {
    ...
    var price = parseInt(counts) * parseInt(products[val]['price']);
    total += price;
    $('.cart-table tbody').append('<tr data-id="'+val+'"><td class="pro-image"><img src="'+products[val]['image']+'" alt=""></td><td class="pro-title" >Leather Mens Slipper</td><td class="pro-price" ><span>'+products[val]['price']+'</span></td><td class="pro-quantity" ><div class="quantity-box"><span class="quantity-down">-</span><span class="quantity-count">'+counts+'</span><span class="quantity-up">+</span></div></td><td class="pro-subtotal" >'+price+'</td><td class="remove" ><i class="fa-regular fa-trash-can"></i></td></tr>');
  });
  $('.total .cart-price-total').text('$'+total);
}
...
$('.first-tab').click(function(e){
  e.preventDefault();
  $('.tabs1').css('background-color',"white").css("color","gray");
  $('.tabs2').css('background-color',"gray").css("color","white")
  $('.tabs3').css('background-color',"gray").css("color","white")
  $('.tab-content-review-box').fadeOut();
  $('.tab-content-description').fadeIn();
})
$('.second-tab').click(function(e){
  e.preventDefault();
  $('.tabs2').css('background-color',"white").css("color","gray")
  $('.tabs1').css('background-color',"gray").css("color","white")
  $('.tabs3').css('background-color',"gray").css("color","white")
  $('.tab-content-description').fadeOut();
  $('.tab-content-review-box').fadeOut();
  $('.tab-content-info-box').fadeIn();
})

$('.third-tab').click(function(e){
  e.preventDefault();
  $('.tabs3').css('background-color',"white").css("color","gray")
  $('.tabs2').css('background-color',"gray").css("color","white")
  $('.tabs1').css('background-color',"gray").css("color","white")
  $('.tab-content-description').fadeOut();
